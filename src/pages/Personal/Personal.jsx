    ...
    <div className={styles.personal}>
      <div className={styles.personalWrap}>
        ...
        <div className={styles.jo}>
          <h2>제1조(목적)</h2>
          <span>
            1. 본 약관은 스타스프레이가 운영하는 온라인 쇼핑몰
            'star-spray.com'에서 제공하는 서비스(이하 '서비스'라 합니다)를
        ...
        <div className={styles.jo}>
          <h2>제2조(정의)</h2>
          <span>
            1. '회사'라 함은, '스타스프레이'가 재화 또는 용역을 이용자에게
            제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화등을 거래할 수
            있도록 설정한 가상의 영업장을 운영하는 사업자를 말하며, 아울러
            'star-spray.com'을 통해 제공되는 전자상거래 관련 서비스의 의미로도
            사용합니다.
            <br />
        ...
        <div className={styles.jo}>
          ...
          <span>
            ...
            약관, 운영정책 및 규칙(이하 '세부지침'이라 합니다)의 규정에
        ...
        <div className={styles.jo}>
          ...
          <span>
            ...
            <br />
            3. '쇼핑몰'은 재화 또는 용역이 품절되거나 상세 내용이 변경되는 경우
            장차 체결되는 계약에 따라 제공할 재화나 용역의 내용을 변경할 수
            있습니다. 이 경우 변경된 재화 또는 용역의 내용 및 제공일자를
            명시하여 즉시 공지합니다.
            <br />
            4. '회사'가 서비스를 정지하거나 이용을 제한하는 경우 그 사유 및
        ...
        <div className={styles.jo}>
          ...
          <span>
            ...
            <br />
            가. 가입신청자가 본 약관에 따라 회원자격을 상실한 적이 있는 경우.
        ...
        <div className={styles.jo}>
          ...
          <span>
            ...
            <br />
            4. 휴면계정으로 전환하고 서비스 이용을 제한할 수 있습니다. 휴면계정
            전환 시 계정 활성을 위해 필요한 아이디(ID), 비밀번호, 이름, 중복가입
            방지를 위한 본인 인증값(DI), 휴대전화 번호를 제외한 나머지 정보는
            됩니다. 다만, 관계법령에 의해 보존할 필요가 있는 경우 '회사'는
            정해진 기간 동안 회원정보를 보관합니다.
          </span>
        </div>
        <div className={styles.jo}>
          <h2>제8조(회원에 대한 통지)</h2>
        ...
        <div className={styles.jo}>
          <h2>제9조(구매신청)</h2>
          <span>
            '이용자'는 온라인 쇼핑몰 상에서 다음 방법 또는 이와 유사한 방법에
            따라 구매를 신청할 수 있으며, '회사'는 '이용자'를 위하여 다음 각호의
            내용을 알기 쉽게 제공하여야 합니다.
            <br />
            1. 재화 또는 용역의 검색 및 선택
            <br />
        ...
        <div className={styles.jo}>
          ...
          <span>
            ...
            <br />
            다. 재판매, 기타 부정한 방법이나 목적으로 구매를 신청하였음이
            인정되는 경우
            <br />
            라. 기타 구매신청을 승낙하는 것이 '회사'의 기술상 현저한 지장을
            초래하는 것으로 인정되는 경우
            <br />
            2. '회사'의 승낙이 본 약관의 '수신확인통지' 형태로 이용자에게 도달한
            시점에 계약이 성립한 것으로 봅니다.
            <br />
            3. '회사'가 승낙의 의사표시를 하는 경우 이용자의 구매신청에 대한
        ...
        <div className={styles.jo}>
          ...
          <span>
            ...
            공서양속에 반하는 정보를 '회사'의 '사이트'에 공개 또는 게시하는 행위
            <br />
