    ...
    <div className={styles.terms}>
      <div className={styles.termsWrap}>
        ...
        <div className={styles.jo}>
          <h2>제1조(목적)</h2>
          <span>
            스타스프레이(이하 ‘회사'라고 함)는 회사가 제공하고자 하는
        ...
        <div className={styles.jo}>
          ...
          <span>
            ...
            라. 표시•광고에 관한 기록 : 6개월
            <br />
            2. 통신비밀보호법에 따른 보유정보 및
            <br />
            가. 보유기간 웹사이트 로그 기록 자료 : 3개월
            <br />
        ...
        <div className={styles.jo}>
          ...
          <span>
            ...
            전송하려는 경우
            <br />나 .「방문판매 등에 관한 법률」에 따른 전화권유판매자가
            육성으로 수신자에게 개인정보의 수집출처를 고지하고 전화권유를 하는
            경우
            <br />
        ...
        <div className={styles.jo}>
          <h2>제24조(개인정보 유출 등에 대한 조치의 예외)</h2>
          <span>
        ...
        <div className={styles.jo}>
          ...
          <span>
            ...
            <br />
            3. 회사는 본조 제2항 본문에 따른 동의를 받으려면 미리 다음 각 호의
            사항 모두를 이용자에게 고지합니다.
            <br />
            가. 이전되는 개인정보 항목
            <br />나 .개인정보가 이전되는 국가, 이전일시 및 이전방법
            <br />다 .개인정보를 이전받는 자의 성명(법인인 경우 그 명칭 및
            정보관리 책임자의 연락처를 말한다)
            <br />
            라. 개인정보를 이전받는 자의 개인정보 이용목적 및 보유ㆍ이용 기간
            <br />
            4. 회사는 본조 제2항 본문에 따른 동의를 받아 개인정보를 국외로
            이전하는 경우 개인정보보호법 대통령령 등 관계법규에서 정하는 바에
            따라 보호조치를 합니다.
          </span>
        </div>
        <div className={styles.jo}>
        ...
        <div className={styles.jo}>
          ...
          <span>
            ...
            전화번호: 010-6272-6828
            <br />
            이메일: info.starspray@gmail.com
          </span>
        </div>
        <div className={styles.jo}>
          <h2>제29조(권익침해에 대한 구제방법)</h2>
          <span>
        ...
        <div>
          <h2>부칙</h2>
          <span>제1조 본 방침은 2024.03.01부터 시행됩니다.</span>
        </div>
      </div>
    </div>
  );
